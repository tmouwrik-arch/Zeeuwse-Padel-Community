...
const s: Record<string,any> = {
  ...
  nav:{position:"fixed",bottom:0,left:0,right:0,background:"#fff",boxShadow:"0 -2px 20px rgba(0,0,0,0.08)",zIndex:100,paddingBottom:"env(safe-area-inset-bottom)",minHeight: "calc(65px + env(safe-area-inset-bottom))"},
